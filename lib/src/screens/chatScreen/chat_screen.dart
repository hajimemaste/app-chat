...
import 'package:messenger_chat/src/screens/viewProfileScreen/view_profile_screen.dart';
import 'package:messenger_chat/src/widgets/message_card.dart';
      ...
      child: SafeArea(
        child: WillPopScope(
          ...
          child: Scaffold(
              ...
              backgroundColor: const Color.fromARGB(225, 234, 248, 255),
              body: Column(
                children: [
                  Expanded(
                    child: StreamBuilder(
